...
import ProductCard from "../components/Products/ProductCard"; // 1. Import the reusable ProductCard

const NewArrivals = () => {
  const { newArrivals, loading, error } = useNewArrivals();
  const [showAll, setShowAll] = useState(false);
  const navigate = useNavigate(); // Still needed for the main card click handled by ProductCard
    ...
    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          // 2. The grid now uses the ProductCard component for a consistent look
